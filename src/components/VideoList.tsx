...
export default function VideoList() {
    ...
    useEffect(() => {
        loadFiles();
        // Poll for updates every 5 seconds (simple alternative to SSE for file list)
    ...
    if (loading && files.length === 0) {
        return <div className="text-center py-8 text-text-secondary">Loading files...</div>;
    }

    if (files.length === 0) {
        return <div className="text-center py-8 text-text-secondary">No files downloaded yet</div>;
    }
